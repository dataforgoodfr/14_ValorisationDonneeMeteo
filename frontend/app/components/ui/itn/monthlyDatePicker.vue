...
const { picked_date_start, picked_date_end, isParamsValid } =
...
<template>
    <div>
        ...
        <div
            v-if="!isParamsValid"
            class="flex justify-center items-center gap-1 mt-1"
        >
            <Icon name="lucide:circle-alert" style="color: red" />
            <p class="text-sm text-error">Dates non valide.</p>
        </div>
    </div>
</template>
