...
def test_fetch_station_overview_filters_by_classe_recente_min() -> None:
    """
...
@pytest.mark.django_db
def test_fetch_station_overview_filters_by_classe_recente_max() -> None:
    """
    GIVEN  STATION_ID_1 classe 1, STATION_ID_2 classe 3
...
@pytest.mark.django_db
def test_fetch_station_overview_filters_by_classe_recente_range() -> None:
    """
    GIVEN  STATION_ID_1 classe 1, STATION_ID_2 classe 3
...
@pytest.mark.django_db
def test_fetch_station_overview_filters_by_date_de_creation_max() -> None:
    """
...
@pytest.mark.django_db
def test_fetch_station_overview_filters_by_date_de_creation_min() -> None:
    """
    GIVEN  STATION_ID_1 créée en 1920, STATION_ID_2 créée en 1980
...
@pytest.mark.django_db
def test_fetch_station_overview_fermeture_max_excludes_open_stations() -> None:
    """
...
@pytest.mark.django_db
def test_fetch_station_overview_fermeture_min_alone_includes_open_stations() -> None:
    """
...
@pytest.mark.django_db
def test_fetch_station_overview_fermeture_min_and_max_excludes_open_stations() -> None:
    """
