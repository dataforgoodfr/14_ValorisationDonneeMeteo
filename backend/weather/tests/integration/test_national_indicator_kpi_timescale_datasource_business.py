...
def test_empty_previous_period_returns_zero_counts_and_none_mean():
    insert_itn_daily(year=2024, month=7, day_of_month=15, itn=25.0)
...
def test_day_equal_to_baseline_counts_neither_above_nor_below():
...
def test_observed_day_without_baseline_is_skipped():
