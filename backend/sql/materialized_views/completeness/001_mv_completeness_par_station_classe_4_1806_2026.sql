DROP MATERIALIZED VIEW IF EXISTS public.mv_completeness_par_station_classe_4_1806_2026;

CREATE MATERIALIZED VIEW public.mv_completeness_par_station_classe_4_1806_2026 AS
WITH params AS (
    SELECT
